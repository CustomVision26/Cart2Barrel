/**
 * Idempotent fix for support hub tables and notification enum values.
 * Run: npm run db:ensure-support-hub
 */
...
const tables = await sql`
  ...
  WHERE table_schema = 'public'
    AND table_name IN ('hub_contact_settings', 'support_tickets', 'support_messages')
  ORDER BY table_name
`;
console.log(
  "support hub schema ready:",
