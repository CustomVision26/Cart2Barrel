    ...
    messages: [
      ...
      },
      {
        ...
        content: [
          ...
          "",
          "Amani Cart2Barrel courier specials need ONLY the retail USD fees a traveler pays the airline on that travel day for:",
          ...
          "",
          "These are airline fees at the airport/on the travel day — not Amani Cart2Barrel platform fees.",
          ...
          "",
          "In notes, write 2–4 clear shopper-facing sentences about this airline's 2nd and 3rd checked-bag policy and typical USD amounts on the travel day. Do not mention 4th bags or Amani Cart2Barrel.",
          "",
