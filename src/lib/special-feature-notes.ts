...
export const SPECIAL_FEATURE_AUTO_NOTES = [
  "This special offers express delivery through a company courier traveler departing for Jamaica during the offer period. The traveler has capacity to carry a second and third suitcase to the special destination. Customers who wish to participate can purchase a suitcase of their choice and pack its contents through Amani Cart2Barrel via in-app tools, or, if they prefer to pack their own suitcase, must do so before the special ends.",
  "",
