...
/** Closed-state styles for native `<select>` (option popup colors are set in globals.css). */
export const nativeSelectFieldClassName = cn(
  inputFieldClassName,
  "h-8 py-1 text-base md:text-sm",
)
