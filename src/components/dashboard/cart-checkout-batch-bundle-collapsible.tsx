      ...
      <div className="flex flex-col gap-3 border-b border-border/40 pb-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
        <div className="flex min-w-0 flex-1 items-start gap-2">
          <Button
            ...
            className={cn(
              "h-9 shrink-0 gap-2 border-border/70 bg-background/80 px-2.5 text-muted-foreground",
        ...
        <div className="flex shrink-0 flex-col items-stretch rounded-lg border border-border/60 bg-background/70 px-3 py-2 sm:items-end sm:text-right">
