  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-muted-foreground">
        All registered Clerk accounts (synced into your database). Each row shows
        contact details and the primary shipping address (name, phone, and street
        saved together). Banning suspends the linked Clerk user and revokes their
        sessions.
      </p>
